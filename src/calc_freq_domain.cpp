...
static void output_fft_result(fft_result_t* result, cJSON* output, const char* prefix)
{
    ...
    // FFT 幅值统计
    cJSON_AddNumberToObject(output, "all_fft_magnitude_mean", result->mag_mean);
    cJSON_AddNumberToObject(output, "all_fft_magnitude_std", result->mag_std);
    cJSON_AddNumberToObject(output, "all_fft_magnitude_min", result->mag_min);
    cJSON_AddNumberToObject(output, "all_fft_magnitude_max", result->mag_max);
    cJSON_AddNumberToObject(output, "all_fft_magnitude_median", result->mag_median);
    cJSON_AddNumberToObject(output, "all_fft_magnitude_q1", result->mag_q1);
    cJSON_AddNumberToObject(output, "all_fft_magnitude_q3", result->mag_q3);
    cJSON_AddNumberToObject(output, "all_fft_magnitude_skew", result->mag_skew);
    cJSON_AddNumberToObject(output, "all_fft_magnitude_kurt", result->mag_kurt);
